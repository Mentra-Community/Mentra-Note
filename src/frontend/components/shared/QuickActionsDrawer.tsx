          ...
          <div className="px-6 pb-8">
            {showTimeRangePicker ? (
              ...
              <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 bg-zinc-50 dark:bg-[#3f4147] border border-zinc-200 dark:border-[#4f545c] rounded-xl text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-white"
                      />
                      <Clock
                        size={16}
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 py-4 rounded-xl font-medium bg-zinc-100 dark:bg-[#3f4147] text-zinc-700 dark:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors"
                  >
                    Back
                  </button>
                  <button
                    ...
                    className={clsx(
                      ...
                      generating
                        ? "bg-zinc-200 dark:bg-[#3f4147] text-zinc-500 cursor-not-allowed"
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-zinc-100 dark:bg-[#3f4147] flex items-center justify-center">
                    <FileText
                      size={20}
