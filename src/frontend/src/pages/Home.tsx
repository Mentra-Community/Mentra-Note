  ...
  return (
    <div className="relative flex items-center justify-center min-h-[calc(100vh-80px)] px-4 sm:px-6">
      <div className="text-center space-y-6 sm:space-y-8 w-full max-w-4xl">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-8 mt-8 sm:mt-12">
          {/* Mentra Logo */}
          <svg
            className="transition-all duration-300 hover:drop-shadow-[0_0_2em_rgba(54,192,125,0.7)] w-12 h-auto sm:w-16"
            viewBox="0 0 726 387"
            fill="none"
          ...
          <svg
            className="animate-spin-slow transition-all duration-300 hover:drop-shadow-[0_0_2em_rgba(97,218,251,0.7)] w-12 h-12 sm:w-16 sm:h-16"
            viewBox="0 0 256 228"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
          ...
          {/* Vite Logo */}
          <svg
            className="transition-all duration-300 hover:drop-shadow-[0_0_2em_rgba(189,52,254,0.7)] w-12 h-12 sm:w-16 sm:h-16"
            viewBox="0 0 256 257"
            xmlns="http://www.w3.org/2000/svg"
          >
            <defs>
